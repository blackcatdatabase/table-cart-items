...
> Lineage: 3 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (2 d)
...
| Pkg folder | [packages\cart-items](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\cart-items) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package cart-items -Apply

...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 3 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 1 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\cart-items](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\cart-items)
...
graph LR
  ...
  cart_items["cart_items"]:::center
  cart_items -->|FK| books["books"]:::link
  cart_items -->|FK| carts["carts"]:::accent
  cart_items -->|FK| tenants["tenants"]:::link
...
- Outbound (depends on): "books", "carts", "tenants"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package cart-items -Apply

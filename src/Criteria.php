 ...
 * - whitelist filtrů: [ 'id', 'cart_id', 'book_id', 'sku', 'variant', 'quantity', 'unit_price', 'price_snapshot', 'currency', 'meta' ]
 * - whitelist pro LIKE hledání: [ 'cart_id', 'sku', 'currency' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'cart_id', 'book_id', 'sku', 'variant', 'quantity', 'unit_price', 'price_snapshot', 'currency', 'meta' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'cart_id', 'sku', 'currency' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'cart_id', 'book_id', 'sku', 'variant', 'quantity', 'unit_price', 'price_snapshot', 'currency', 'meta' ], true);
            $parts = [];

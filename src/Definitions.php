...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'cart_id', 'book_id', 'sku', 'variant', 'quantity', 'unit_price', 'price_snapshot', 'currency', 'meta' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'cart_id', 'book_id', 'sku' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'tenant_id', 'book_id', 'quantity' ]; }

...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'cart_id', 'book_id', 'sku', 'sku_norm', 'variant', 'quantity', 'unit_price', 'price_snapshot', 'currency', 'meta', 'created_at', 'updated_at' ]; }

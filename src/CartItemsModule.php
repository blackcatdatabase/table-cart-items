...
final class CartItemsModule implements ModuleInterface {
    ...
    /** @return string[] */
    public function dependencies(): array { return [ 'table-books', 'table-carts' ]; }
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $indexes = [ 'idx_cart_items_cart_id', 'ux_cart_items' ];
        $fks     = [ 'fk_cart_items_book', 'fk_cart_items_cart' ];
        $missingIdx = [];
        $missingFk  = [];

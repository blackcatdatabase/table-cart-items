...
final class CartItemDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'cart_id' => 'cartId', 'book_id' => 'bookId', 'unit_price' => 'unitPrice', 'price_snapshot' => 'priceSnapshot' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'book_id', 'quantity' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'sku', 'variant', 'meta' ];

...
namespace BlackCat\Database\Packages\CartItems\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO CartItemDto:
 ...
 */
final class CartItemDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'tenant_id' => 'tenantId', 'cart_id' => 'cartId', 'book_id' => 'bookId', 'sku' => 'sku', 'sku_norm' => 'skuNorm', 'variant' => 'variant', 'quantity' => 'quantity', 'unit_price' => 'unitPrice', 'price_snapshot' => 'priceSnapshot', 'currency' => 'currency', 'meta' => 'meta', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'tenant_id', 'book_id', 'quantity' ];
    /** @var string[] */
    private const FLOAT_COLS  = [ 'unit_price', 'price_snapshot' ];
    /** @var string[] */
    private const JSON_COLS   = [ 'variant', 'meta' ];
    /** @var string[] */
     ...
     * @return CartItemDto
     */
    public static function fromRow(array $row): CartItemDto
    {
        /** @var CartItemDto */
    ...
    public static function fromRowOrNull(?array $row): ?CartItemDto
    {
     ...
     */
    public static function toRow(CartItemDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(CartItemDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(CartItemDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(CartItemDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,CartItemDto>
     */
